    ...
    return (
        <main className="">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <h1 className="text-4xl font-bold text-foreground mb-2">استشارات-هندسية-ابوظبي</h1>
                <p className="text-muted-foreground text-sm">Home / استشارات-هندسية-ابوظبي</p>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
                ...
                <h2 className='text-xl font-semibold mb-5'>Contact us today</h2>
                <p className="text-neutral-500 text-base leading-relaxed mb-6">
