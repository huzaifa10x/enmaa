...
export default function OurProjects() {
    ...
    const getPositionClass = (i) => {
        ...
        switch (diff) {
            ...
            case 1: // right
                return "z-20 lg:scale-100 md:scale-50 scale-[0.3] opacity-100 brightness-50 translate-x-[13rem] md:translate-x-[21rem] lg:translate-x-[38rem]"
            case 2: // far right
                return "z-10 lg:scale-0 md:scale-[0.4] scale-0 opacity-80 brightness-50 translate-x-[6rem] md:translate-x-[20rem] lg:translate-x-[48rem]"
            case items.length - 1: // left
                return "z-20 lg:scale-100 md:scale-50 scale-[0.3] opacity-100 brightness-50 -translate-x-[13rem] md:-translate-x-[21rem] lg:-translate-x-[38rem]"
            case items.length - 2: // far left
                return "z-10 lg:scale-0 md:scale-[0.4] scale-0 opacity-80 brightness-50 -translate-x-[6rem] md:-translate-x-[20rem] lg:-translate-x-[48rem]"
            default:
                return "opacity-0 lg:scale-50 md:scale-[0.3]"
        }
    }

    return (
        <section ref={sectionRef} className="relative w-full flex flex-col py-10 overflow-hidden items-center justify-center rounded-t-[50px] z-50 bg-neutral-200 -mt-10">
            ...
            {/* Buttons */}
            <div className="relative z-10 flex flex-wrap items-center md:justify-between justify-center md:mt-40 gap-9 w-full max-w-7xl">
